...
<title>Eliminar profesor | Otro Espacio Web Prácticas</title>
...
<nav class="navbar navbar-default" role="navigation">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<?php 
					...
					$codigo=$_GET['codigo'];
					$consulta="delete from profesores where codprof='$codigo'";
					$resultado=mysql_query($consulta,$cone);
					if(!$resultado){
						die ("consulta invalida ".mysql_error());
					}else{
						echo "Docente eliminado de la base de datos";
					}
					mysql_close($cone);
				?>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<a href="../php/manejo.php" class="btn btn-primary btn-lg" title="Volver a PHP">Regresar</a>
			</div>
		</div>
	</div>
