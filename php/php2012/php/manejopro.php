...
<title>Administración de programas | Otro Espacio Web Prácticas</title>
...
<nav class="navbar navbar-default" role="navigation">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1>Administración de programas</h1>
				<h2>Agregar un nuevo programa</h2>
				<form name="insertar" action="agregarpro.php" method="get">
					<label for="descripcion">Descripci&oacute;n</label>
					<input class="form-control" type="text" name="descripcion" required maxlength="20" autocomplete="off" />
					<br />
		...
		<div class="row">
			<div class="col-md-12">
				...
				<form action="modificapro.php" name="modificar" method="get">
					...
					<input class="form-control" type="text" name="descripcion" maxlength="20" required /><br />
		...
		<div class="row">
			<div class="col-md-12">
				<a href="listadospro.php" class="btn btn-primary btn-lg" title="Atras">Volver</a>
			</div>
		</div>
	</div>
